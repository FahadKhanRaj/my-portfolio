    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          ...
          <h2 className="section--heading">Soon, I will add my projects here.</h2>
        </div>
        <div>
          {/* <button className="btn btn-github"> */}
          <button className="btn btn-github" onClick={() => window.open("https://github.com/FahadKhanRaj", '_blank')}>
            ...
            Visit My GitHub
              {/* <a href="https://github.com/your-username">Visit My GitHub</a> */}
