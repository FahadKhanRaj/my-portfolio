...
function Footer() {
  return (
    <footer className="footer--container">
      ...
      <div>
  <img src="./img/logo.png" alt="Logoipsum" style={{ width: "50px", height: "50px" }} />
</div>
    ...
    className="text-md"
    onClick={() => alert("Clicking this link will open your email client to send an email to youremail@example.com.")}
  ></a>
                Contact
              </Link>
      ...
      <div className="footer--content--container">
        <p className="footer--content">An Attempt of Making my Portfolio Website</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
